...
> The published Astro site is the primary user-facing documentation. This
> directory keeps Markdown source, research notes, and project material close
> to the code. Start with [project status](status.md) or the
> [online docs](https://sachncs.github.io/reachq/).
...
See [the reachability tutorial](tutorials/quickstart-reachability.md), [the algorithms guide](concepts/algorithms.md), and the [API reference](reference/index.md).
...
See [the shortest-path tutorial](tutorials/quickstart-shortest-paths.md), [the algorithms guide](concepts/algorithms.md), and the [API reference](reference/index.md).
...
- The current package artifacts are pure Python; Cython, Numba, and Rust code under `reachq/accel/` is opt-in and experimental.
...
See the full [limitations page](concepts/limitations.md) before adopting reachq for production decisions.
...
The [benchmark guide](guides/benchmarking.md) separates theoretical bounds, microbenchmarks, and end-to-end measurements.

## Documentation map

- [Installation and first construction](getting-started/installation.md)
- [Reachability tutorial](tutorials/quickstart-reachability.md)
- [Shortest-path tutorial](tutorials/quickstart-shortest-paths.md)
- [Algorithms and refinements](concepts/algorithms.md)
- [API reference](reference/index.md)
- [Examples](getting-started/examples.md)
- [Implementation notes](research/provenance.md)
- [Benchmarks](guides/benchmarking.md)
- [Testing](project/testing.md)
- [Limitations](concepts/limitations.md)
- [Glossary](reference/glossary.md)

Research provenance and historical material live under [Research](research/provenance.md) and the repository archive; they do not redefine the supported API.

## Research and contribution

The constructions are informed by *Parallel Reachability and Shortest Paths on Non-sparse Digraphs* by Ashvinkumar, Bernstein, Probst Gutenberg, and Saranurak. See [the provenance notes](research/provenance.md) for the relationship between the paper, this implementation, and experimental extensions.
